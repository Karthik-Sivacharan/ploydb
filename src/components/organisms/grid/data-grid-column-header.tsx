      ...
      <DropdownMenu modal={false}>
        ...
        >
          <div className="flex min-w-0 flex-1 items-center gap-1.5">
            ...
            {(column.columnDef.meta?.source === "lookup" || column.columnDef.meta?.source === "clearbit") && (
              <Tooltip delayDuration={100}>
                <TooltipTrigger asChild>
                  <Link2Icon className="size-3 shrink-0 text-lookup-accent" />
                </TooltipTrigger>
                <TooltipContent side="top">
                  <p>{column.columnDef.meta?.source === "clearbit" ? "Clearbit" : "Linked from another table"}</p>
                </TooltipContent>
              </Tooltip>
            )}
            {column.columnDef.meta?.source === "ai-generated" && (
              <Tooltip delayDuration={100}>
                <TooltipTrigger asChild>
                  <FilePenLineIcon className="size-3 shrink-0 text-ai-accent" />
                </TooltipTrigger>
                <TooltipContent side="top">
                  <p>{column.id === "fld_website_visits" ? "Pulled from Clearbit by Korra" : "Generated by Korra"}</p>
                </TooltipContent>
              </Tooltip>
            )}
          </div>
